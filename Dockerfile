...
ENV BOT_API_RATE_LIMIT_PER_MINUTE="60"
ENV BOT_API_RATE_LIMIT_PER_HOUR="1000"
ENV GLOBAL_API_ENABLE_CORS="true"
ENV GLOBAL_API_ALLOWED_ORIGINS="*"

## Performance Monitoring defaults
ENV BOT_ENABLE_PERFORMANCE_TRACKING="true"
ENV BOT_TRACK_RESPONSE_TIMES="true"
ENV BOT_TRACK_MEMORY_USAGE="true"
ENV BOT_COLLECT_CRISIS_STATS="true"
ENV BOT_COLLECT_KEYWORD_STATS="true"
ENV BOT_COLLECT_LEARNING_STATS="true"
ENV BOT_API_RATE_LIMIT_PER_MINUTE="90"
ENV BOT_LOGS_RETENTION_DAYS="30"
